...
void *philosopher(void *num) {
  ...
  do {
    ...
    palito_ocupado[left_chopstick] = 0;
    pthread_mutex_unlock(&chopstick[right_chopstick]);
    printf("Philosopher %ld: released chopstick %d\n", id, right_chopstick);
    palito_ocupado[right_chopstick] = 0;
